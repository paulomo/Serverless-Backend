...
/**
 * Get the IAM policies for a Tenant Admin 
...
/**
 * Get the IAM policies for a Tenant user
 * @param policyParams Dictionary with configuration parameters
...
/**
 * Get the IAM policies for a System Admin
 * @param policyParams Dictionary with configuration parameters
 * @returns The populated tenant user policy template
 */
...
/**
 /**
 * Get the IAM policies for a System user
 * @param policyParams Dictionary with configuration parameters
 * @returns The populated tenant user policy template
 */
